# Image Paste — Planning Document - Done May 6, 2026
...
- **Pasted text/uri-list (http/https URL)**: insert the URL verbatim as `![](https://file%2B.vscode-resource.vscode-cdn.net/Users/michaeljosephwork/git/mikedown/planning/url)`. Do not download.
...
3. **Webview**: insert `![alt](https://file%2B.vscode-resource.vscode-cdn.net/Users/michaeljosephwork/git/mikedown/planning/path)` via a ProseMirror transaction at the current selection. (Per existing feedback memory: never mutate `editor.view.dom` outside a PM transaction.)
...
- [ ] Paste an `https://…` image URL → inserted as `![](https://file%2B.vscode-resource.vscode-cdn.net/Users/michaeljosephwork/git/mikedown/planning/url)`, no file written.
